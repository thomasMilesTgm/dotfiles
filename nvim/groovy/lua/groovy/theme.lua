...
local c = require('groovy.palette')
...
theme.set_highlights = function()
  ...
  hl(0, "Visual", { fg = 'NONE', bg = c.ui4_blue })
  ...
  hl(0, "Identifier", { fg = c.light_blue, bg = 'NONE', italic=true, })
  hl(0, "Function", { fg = c.purple, bg = 'NONE', italic=true, })
  hl(0, "Operator", { fg = c.fg, bg = 'NONE' })
  hl(0, "Type", { fg = c.cyan, bg = 'NONE' })
  hl(0, "StorageClass", { fg = c.red, bg = 'NONE', italic=true, })
  hl(0, "Structure", { fg = c.purple, bg = 'NONE' })
  hl(0, "Typedef", { fg = c.blue, bg = 'NONE' })
  hl(0, "Keyword", { fg = c.blue, bg = 'NONE', italic=true, })
  ...
  hl(0, "Macro", { fg = c.red, bg = 'NONE', italic=true, })
  ...
  hl(0, "SpecialComment", { fg = c.gray, bg = 'NONE', bold=true, })
  hl(0, "Underlined", { fg = 'NONE', bg = 'NONE', underline=true, })
  hl(0, "Bold", { fg = 'NONE', bg = 'NONE', bold=true, })
  hl(0, "Italic", { fg = 'NONE', bg = 'NONE', italic=true, })
  hl(0, "Ignore", { fg = c.cyan, bg = c.bg, bold=true, })
  hl(0, "Todo", { fg = c.blue, bg = c.bg, bold=true, })
  ...
  hl(0, "TSParameterReference", { fg = c.green, bg = 'NONE' })
